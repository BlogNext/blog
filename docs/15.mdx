...
icon: icon-react
auth: LaughingZhu
cover: https://cdn.laughingzhu.cn/2dd2c8dd-b108-4b02-86d7-5cd295e12df8.png
---
...
由于这里子组件并没有依赖父组件的state、props，所以理论上我们是不期望Child多次渲染的，这里就可以通过使用[React.memo()](https://zh-hans.reactjs.org/docs/react-api.html#reactmemo)来解决。
