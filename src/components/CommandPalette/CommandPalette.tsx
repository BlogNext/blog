  ...
  return (
    <KBarResults
      ...
      onRender={({ item, active }) =>
        typeof item === 'string' ? (
          <div className='px-4 pb-2 pt-4 font-medium text-gray-500 dark:text-gray-400'>{item}</div>
        ) : (
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={`${
          active ? 'bg-primary-500 rounded-lg text-gray-100' : 'text-gray-600 dark:text-gray-300'
